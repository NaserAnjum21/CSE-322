...
set nm udp_wireless_mobile.nam
set tr trace_udp_wireless_mobile.tr
set topo_file topo_udp_wireless_mobile.txt
...
$ns_ at [expr $start_time+$time_duration +$extra_time+1] "$ns_ nam-end-wireless [$ns_ now]; puts \"NS Exiting...\"; $ns_ halt"
